...
csv_request = csv(practice_probability_file).then(function(practice_prob_data) {
  csv_request = csv(probability_file).then(function(prob_data) {
    const timeline_var = [];
    trial = 0;
