...
//   choices: jsPsych.ALL_KEYS,
//   prompt: 'You should now hear beeps playing. If so, ' +
//                'press the space bar to proceed to the audio test.',
// });
...
//   type: 'fullscreen',
//   message: '<p> Press start to enter ' +
//              'full-screen mode and start the game. </p>',
//   button_label: 'Start',
